...
**Le site public — « les bandes qui alternent ».** La page ne pose pas de cartes sur un fond : elle avance par bandes pleine largeur qui alternent le crème (`#f8f4ec`) et l'ardoise chaude (`#343b3d`), sans jamais rien encadrer. Le contenu est posé à même la bande, tenu par des filets de 1 px et par l'espace ; l'ombre ne sert qu'aux médaillons et aux médias, jamais à découper un bloc de texte. Chaque bande porte un ou deux ornements au trait, dessinés pour ce site — bambou, feuillage, courbes de niveau, vigne dorée, ensō, volutes — et une seule illustration en matière, la pile de galets. La discipline que le site présente fusionne quatre pratiques en un seul enchaînement continu ; la page fait de même, une bande coulant dans la suivante par une coupure courbe plutôt qu'une ligne droite.
